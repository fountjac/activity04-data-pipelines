...
**Response**:Major and Unemployment Rate. In SAS I would PROC MEANS 
and use a by statement for Major and select the variable unemployment_rate.
...
**Response**: Majors with higher proportions of women tend to be more social and education leaning.
