...
**Response**: When true messages from the console are included
...
**Response**: I couldn’t find the difference
...
**Response**:Major and Unemployment Rate. In SAS I would PROC MEANS and
use a by statement for Major and select the variable unemployment\_rate.
...
**Response**: Majors with higher proportions of women tend to be more
social and education leaning.
...
**Response**:10 STEM majors have median salaries under 36000
